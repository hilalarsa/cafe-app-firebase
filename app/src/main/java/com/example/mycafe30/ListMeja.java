...
public class ListMeja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Meja").child(ID_USER);

        initViews();
        initListener();

        listViewMejas.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
...
//        final Button buttonViewList = dialogView.findViewById(R.id.buttonViewList);
    ...
    private boolean updateMeja(String id, String no, String jumlah, String status) {
        ...
        Meja Meja = new Meja(id, no, jumlah, status, ID_USER);
